...
//			// The values are in values. Save the returned Uri in newItemUri
			...
			Uri newItemUri = ContentUris.withAppendedId(Expense.ExpenseItem.CONTENT_URI, mExpenseId);
...
// 			// Use null for the where clause and selection arguments
			...
			getContentResolver().update(mBaseUri, values, null, null);
//
		}
	}
