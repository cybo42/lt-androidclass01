...
//Leave this alone until the end of the exercise
    ...
    private void editExpenseItem(Uri expenseUri) {

        Intent editExpenseItem = new Intent(this, ExpenseEntryActivity.class);
        editExpenseItem.setData(expenseUri);
        startActivity(editExpenseItem);
