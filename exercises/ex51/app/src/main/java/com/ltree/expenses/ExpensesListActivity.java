...
public class ExpensesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.setOnItemClickListener(new ListClickHandler()); //Disabled for this exercise
    ...
    private class ListClickHandler implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent viewEntryIntent = new Intent(ExpensesListActivity.this, ExpenseEntryActivity.class);
            Object o = parent.getItemAtPosition(position);
            viewEntryIntent.putExtra(Expense.ExpenseItem.COLUMN_NAME_DESCRIPTION, "description");
            viewEntryIntent.putExtra(Expense.ExpenseItem.COLUMN_NAME_AMOUNT, 15.2);
            viewEntryIntent.putExtra(Expense.ExpenseItem.COLUMN_NAME_ID, "ID");
            viewEntryIntent.putExtra(Expense.ExpenseItem.COLUMN_NAME_EXPENSE_DATE, System.currentTimeMillis());
