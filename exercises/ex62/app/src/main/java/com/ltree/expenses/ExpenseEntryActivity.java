...
public class ExpenseEntryActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, DateUpdater{
	...
	public class ReceiptButtonListener implements View.OnClickListener {
		...
		@Override
		public void onClick(View v) {
			// TODO 3 Create an implicit Intent to start the Camera app (MediaStore.ACTION_IMAGE_CAPTURE)
			...
			File baseDir = new File(getFilesDir(), Environment.DIRECTORY_PICTURES);
			...
			Log.v(TAG, "creating director " + receiptsDir);
			...
			Log.v(TAG, "should save file to URI: " + uri);
