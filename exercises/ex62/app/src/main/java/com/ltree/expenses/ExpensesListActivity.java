...
public class ExpensesListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Request any required permissions (API 23)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_add:
                addExpenseItem();
                return true;
			// TODO What method is called when the export menu option is selected?
...
//Leave this alone until the end of the exercise
    ...
    private void startExport() {
        ...
        // TODO 21 Create an Intent with SyncService as the target
        Intent startSyncService =new Intent(this, SyncService.class);
        // TODO Note that we set a flag to notify the service that we want to export to a CSV file
        startSyncService.putExtra(Constants.EXPENSE_EXTRA_EXPORT_TO_CSV, true);

        // TODO 22 Use the Intent to start the service
        startService(startSyncService);
