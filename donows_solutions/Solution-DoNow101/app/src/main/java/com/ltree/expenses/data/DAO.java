...
public class DAO {
	 ...
	 */
	public int deleteExpensesById(long id) {
        String finalWhere =
	 ...
	 */
	public Cursor queryExpenseById(long expenseId, String[] projection)
	{
	 ...
	 * @return
	 */
    public int updateExpenseById( long expenseId, ContentValues values) {
