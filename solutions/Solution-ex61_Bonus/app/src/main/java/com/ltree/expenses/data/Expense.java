...
public final class Expense implements java.io.Serializable{
    ...
    public static final String AUTHORITY = "com.ltree.expenses.expenses";	// The Content Provider Authority
    ...
    public static final class ExpenseItem implements BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.ltree.expenses.expense";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single expense item
         *
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.ltree.expenses.expense";
    ...
    public static final class Helper {
        ...
        public static final StringBuilder expenseArrayToCsv(Expense[] expenses){
            StringBuilder result= new StringBuilder();
            for(Expense e: expenses){
                result.append(expenseToCsv(e));
            }
            return result;
        }

        public static final StringBuilder  expenseToCsv(Expense e){
            StringBuilder builder = new StringBuilder();
            builder.append(e.description);
            builder.append(',');
            builder.append(e.amount);
            builder.append(',');
            builder.append(sdf.format(new Date(e.expenseDate)));
            builder.append('\n');
            return builder;
        }
    }
