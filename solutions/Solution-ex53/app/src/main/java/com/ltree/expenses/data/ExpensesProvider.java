...
/*		
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case EXPENSES:
            	// TODO use the DAO to delete the expenses by where clause
            	//count = 
            	break;
            ...
            case EXPENSES_ID:
                // TODO extract the expenseId from the URI
            	//int expenseId = 
            	// TODO use the DAO to delete the expenses by id
            	//count = 
                break;
...
*/        		
	...
	/*		
	        ...
	        // TODO 40 call the insertExpense method on the DAO
	        ...
	        if (expenseId > 0) {
	            ...
	            // TODO 41 append the id of the new expense to the base URI
	            Uri expenseUri = ContentUris.withAppendedId(Expense.ExpenseItem.CONTENT_ID_URI_BASE, ______);
				
	            // Notifies observers registered against this provider that the data changed.
	            // TODO 42 notify observers that the new id has been added 
	            getContext().getContentResolver().notifyChange(_______, null);
	            return expenseUri;
	        }
	...
	*/
			// TODO 43 - delete the old return statement
			return null;
	...
	public boolean onCreate() {
		// TODO 20 Create an instance of the DAO (you can get the context with getContext())
	...
	public Cursor query(Uri uri, String[] projection, String selection,
	        ...
	        */
		   // TODO 30 decide which action to take by matching the supplied URI
	       switch (sUriMatcher.match(uri)) {
	           
	           case EXPENSES:
	        	   // If the incoming URI is for expenses, call the queryExpenses method on the DAO	        	   
	        	   // TODO 31 call queryExpenses. The arguments you need were all passed into this method
	           ...
	           case EXPENSES_ID:
	        	   ...
	        	   // TODO 32 Retrieve the ID of the expense to search for from the uri passed into this method
	        	   // Hint: use a ContentUris method
	        	   
	        	   long expenseId = ContentUris.parseId(uri);
	        	   
	        	   // TODO 33 Call queryExpenseById on the DAO to perform the query
	       ...
	       // TODO 34 return the newly retrieved cursor
...
/*		
        ...
        switch (sUriMatcher.match(uri)) {
			...
			// TODO Notify any observers that content has changed
