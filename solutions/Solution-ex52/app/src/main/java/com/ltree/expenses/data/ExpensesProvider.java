...
public class ExpensesProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
	        ...
	        */
		   // TODO 30 decide which action to take by switching on the supplied URI
	       switch (sUriMatcher.match(uri)) {
	           ...
	           case EXPENSES_ID:
	        	   ...
	        	   // The ID is located in segment 1 of the uri path
	        	   // Use the constant Expense.ExpenseItem.EXPENSE_ID_PATH_POSITION to identify this position
	       ...
	       // TODO 34 Configure notification on the cursor
	       cursor.setNotificationUri(getContext().getContentResolver(), uri);
	       // TODO 35 return the newly retrieved cursor
