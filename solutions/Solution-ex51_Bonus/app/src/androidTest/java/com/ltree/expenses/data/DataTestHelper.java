...
public class DataTestHelper {
    ...
    public static final Expense[] TEST_EXPENSES = {
        new Expense("Description0", 0.0f, START_DATE  +  ONE_DAY_MILLIS * 9),
        new Expense("Description1", 1.0f, START_DATE + ONE_DAY_MILLIS * 8),
        new Expense("Description2", 2.0f, START_DATE + ONE_DAY_MILLIS * 7),
        new Expense("Description3", 3.0f, START_DATE +  ONE_DAY_MILLIS * 6),
        new Expense("Description4", 4.0f, START_DATE + ONE_DAY_MILLIS * 5),
        new Expense("Description5", 5.0f, START_DATE +  ONE_DAY_MILLIS * 4),
        new Expense("Description6", 6.0f, START_DATE +  ONE_DAY_MILLIS * 3),
        new Expense("Description7", 7.0f, START_DATE +  ONE_DAY_MILLIS * 2),
        new Expense("Description8", 8.0f, START_DATE  +  ONE_DAY_MILLIS ),
        new Expense("Description9", 9.0f, START_DATE) };	
